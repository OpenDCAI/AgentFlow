...
echo "============================================"
echo ""
echo "IMPORTANT: Always run commands from the project root directory:"
echo "  cd $(pwd)"
echo ""
echo "Quick start:"
echo "  # 1. Start sandbox server"
echo "  ./start_sandbox_server.sh --config configs/sandbox-server/web_config.json"
echo ""
echo "  # 2. Run synthesis"
echo "  python -m synthesis.pipeline --config configs/synthesis/doc_config.json"
echo ""
echo "  # Or via Python API"
echo "  python -c \"from synthesis import synthesize; synthesize(config_path='configs/synthesis/doc_config.json')\""
echo ""
