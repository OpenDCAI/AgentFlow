...
sampling_tips:
  ...
  - Use both RAG and web tools at least once per trajectory
  - Use web-visit at least once to extract evidence from specific pages
  - Prefer web tools for public/fresh facts and RAG for internal context
...
synthesis_tips:
  ...
  - Make the question require both RAG and web evidence
